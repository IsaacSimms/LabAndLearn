...
## TL;DR
Modern computing environments demand availability, reliability, and the ability to scale at insane rates. This forces production systems into a distributed context in most circumstances. Building these systems has been histroally difficuult, and bespoke with a small class of humans able to perform at a very high level. Containers, orchestrators, and related infrastrcutre has provided us with the building blocks to reuse, share, and modify established architecture. (Think what OOP did for programming) This book focuses in on general must knows for the art of distributed systems and more specifically, commonly used patterns. 
...
But: these sytems are much harder to design, build, maintain, and debug

### Short history
All compute used to happen on a single machine. Then, a progression started to play out as performance, secuirty, and reliability became more demanding. Single boxes-->client-server-->large scale distributed systems (started in the early 2000s)
